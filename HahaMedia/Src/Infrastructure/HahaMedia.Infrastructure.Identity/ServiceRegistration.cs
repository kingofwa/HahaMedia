...
namespace HahaMedia.Infrastructure.Identity
{
                ...
                .AddJwtBearer(async o =>
                {
                    ...
                    o.Events = new JwtBearerEvents()
                    {
                        OnChallenge = context =>
                        {
                            ...
                            var result = JsonSerializer.Serialize(new BaseResult(new Error(ErrorCode.AccessDenied, "You are not Authorized")), serializerSettings);
                        ...
                        OnForbidden = context =>
                        {
                            ...
                            context.Response.ContentType = "application/json";
                            var result = JsonSerializer.Serialize(new BaseResult(new Error(ErrorCode.AccessDenied, "You are not authorized to access this resource")), serializerSettings);
                            return context.Response.WriteAsync(result);
                        },
